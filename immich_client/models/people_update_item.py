...
class PeopleUpdateItem:
    ...
    Attributes:
        ...
        feature_face_asset_id (Union[Unset, UUID]): Asset is used to get the feature face thumbnail.
    ...
    feature_face_asset_id: Union[Unset, UUID] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feature_face_asset_id: Union[Unset, UUID]
