...
class AssetMediaCreateDto:
    ...
    Attributes:
        ...
        live_photo_video_id (Union[Unset, str]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sidecar_data: Union[Unset, FileTypes] = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.live_photo_video_id, Unset):
            files.append(("livePhotoVideoId", (None, str(self.live_photo_video_id).encode(), "text/plain")))
